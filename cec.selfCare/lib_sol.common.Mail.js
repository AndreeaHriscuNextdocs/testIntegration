...
sol.define("sol.common.Mail", {
  ...
  initSession: function () {
    ...
    me.logger.debug(["JavaMail: version={0}, library.path={1}", me.session.getClass().package.implementationVersion, me.session.getClass().protectionDomain.codeSource.location.path]);
