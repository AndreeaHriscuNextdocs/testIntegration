...
sol.define("sol.common.SordProvider", {
  ...
  escapeOrRemoveInvalidCharacters: function (val) {
    var me = this;
    return val
      .replace(me.escapeRegEx || (me.escapeRegEx = me.buildRegEx(me.ESCAPE_VALUES)), "\\$1")
      .replace(me.removeRegEx || (me.removeRegEx = me.buildRegEx(me.BLANK_VALUES)), " ")
      .replace(me.removeDupWhiteSpaces || (me.removeDupWhiteSpaces = /\s\s+/g), " ") // remove probably invalid double/tripple whitespaces
      .trim();
  },
