...
sol.define("sol.common.IxUtils", {
   ...
   */
  optimizedExecute: function (rf, config, cacheObject, optimization, excludeFromConfig) {
    var result;
    try {
    ...
    return (cacheObject[optimization] = (result = sol.common.IxUtils.execute(rf, config)).optimization), result; // store optimization ID in cache
  },
